 ...
 * <p/>
 * This class provides base logic to setup the image, transform it with matrix (move, ic_scale, rotate),
...
public class EditImageView extends ImageView {
    ...
    /**
     * Interface for rotation and ic_scale change notifying.
     */
     ...
     *
     * @param inputUri - image Uri
     * @throws Exception - can throw exception if having problems with decoding Uri or OOM.
     */
    public void setImageUri(@NonNull final Uri inputUri, @Nullable final Uri outputUri) {
    ...
    /**
     * @return - current image ic_scale value.
    ...
    /**
     * This method calculates ic_scale value for given Matrix object.
     */
    ...
    /**
     * This method logs given matrix X, Y, ic_scale, and angle values.
    ...
    protected void printMatrix(@NonNull String logPrefix, @NonNull Matrix matrix) {
        ...
        Log.d(TAG, logPrefix + ": matrix: { x: " + x + ", y: " + y + ", ic_scale: " + rScale + ", angle: " + rAngle + " }");
    }
